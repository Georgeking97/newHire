...
public final class newHireGrpc {
  ...
  public static abstract class newHireImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public void sendMessage(newHire.create.permissions.MessageRequest request,
  ...
  public static final class newHireBlockingStub extends io.grpc.stub.AbstractStub<newHireBlockingStub> {
     ...
     * </pre>
     */
    public java.util.Iterator<newHire.create.permissions.MessageReply> sendMessage(
        newHire.create.permissions.MessageRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_SEND_MESSAGE:
          serviceImpl.sendMessage((newHire.create.permissions.MessageRequest) request,
              (io.grpc.stub.StreamObserver<newHire.create.permissions.MessageReply>) responseObserver);
          break;
        default:
